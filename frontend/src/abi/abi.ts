export const abi = [
    ...
    },
    {
      ...
      "name": "createRound",
      "inputs": [
        { "name": "_answer", "type": "bytes32", "internalType": "bytes32" }
      ],
      "outputs": [],
      "stateMutability": "nonpayable"
    },
    ...
    {
      "type": "error",
      "name": "Panagram_AlreadyAnsweredCorrectly",
      "inputs": []
    },
    { "type": "error", "name": "Panagram_FirstPanagramNotSet", "inputs": [] },
    { "type": "error", "name": "Panagram_IncorrectGuess", "inputs": [] },
    {
      "type": "error",
      "name": "Panagram_MinTimeNotPassed",
      "inputs": [
        { "name": "minTime", "type": "uint256", "internalType": "uint256" },
        { "name": "timePassed", "type": "uint256", "internalType": "uint256" }
      ]
    },
    { "type": "error", "name": "Panagram_NoRoundWinner", "inputs": [] }
  ]